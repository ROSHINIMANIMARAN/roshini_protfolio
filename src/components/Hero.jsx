...
import heroVideo from '../assets/hero video/Female_developer_speaking_in_office_202607021432.mp4';
    ...
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            Hi, I’m <span className="text-transparent [-webkit-text-stroke:1.5px_white]">Roshini M.</span> <br />
            <span className="text-white">Full Stack Developer & Cybersecurity Analyst</span>
          </h1>
          ...
          >
            I build fast, scalable, and secure web applications using React, Laravel, Node.js, PHP and MySQL, while specializing in ethical hacking, vulnerability assessments, and network pentesting.
          </p>
